...
int main() {
...

  {
   ...
   {
    String str1(";o;w;wie; oww; oww");
    std::vector<String> result = str1.split(';');
    std::vector<String> ans = { "","o","w","wie", " oww", " oww" };
    assert(str1 == ";o;w;wie; oww; oww" );
    assert(result == ans);
    }

  {
    ...
    for(std::vector<String>::const_iterator i = ans.begin(); i != ans.end(); ++i)
      std::cout << *i << ' ';
